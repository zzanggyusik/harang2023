...
class App():
    def __init__(self):
        ...
        if mode == 'g':
            self.dataset_path = 'Grapefruit'
            
        elif mode == 'b':
            self.dataset_path = 'Banana'
    ...
    def cam_open(self):
        ...
        while True:
            ...
            filename = f'{AppConfig.root_path}/{self.dataset_path}/{i}.jpg'
            cv2.imwrite(filename, (img[0] * 255).astype(np.uint8))
            print(i)
